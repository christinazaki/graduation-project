...
/**
 * Generated class for the MixQuestionsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-mix-questions',
  templateUrl: 'mix-questions.html',
})
export class MixQuestionsPage {
  ...
  this.QuRef=this.database.list('MixQuestions');
...
this.navCtrl.setRoot('MixQuestionsPage');
