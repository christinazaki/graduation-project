...
/**
 * Generated class for the WhoWhereWhatQuestionsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-who-where-what-questions',
  templateUrl: 'who-where-what-questions.html',
})
export class WhoWhereWhatQuestionsPage {
  ...
  this.QuRef=this.database.list('WhoWhereWhatQuestions');
...
this.navCtrl.setRoot('WhoWhereWhatQuestionsPage');
